	<div class="container-fluid">
										...
										<div class="content">
											<div class="row">
												...
												<div class="col-auto ms-auto">
													...
													<a type="button" class="btn btn_bg" href="<?php echo base_url(); ?>doctors/create">
													  	<i class="fas fa-plus"></i> Add New Doctors
</a>
         ...
         if (result.value) {
            window.location.href = "<?php echo base_url();?>doctors/delete/"+userId;
         }
         }); 
