   ...
   <div class="container-fluid">
								<div class="row px-3 ">
									<div class="col-12 bg_grey">
										<div class="">
										 ...
										 <?php echo form_open_multipart('settings/branch/create',array('class' => 'form-vertical input_form', 'id' => 'insert_purchase','name' => 'insert_purchase'))?>
                              ...
                              <div class="form-group col-md-6">
                                ...
                                <div class="form-group col-md-6">
                                 ...
                                 <input type="text" id="address" class="form-control" name="address"  value="<?php echo set_value('address'); ?>" required>
