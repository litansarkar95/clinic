...
.costing-list span {
  ...
  <!-- .col-sm-7 -->
                  <div class="col-sm-12">
                   ...
                   <span class="btn-label"><i class="glyphicon glyphicon-plus"></i></span>Add New Doctor
                      </button>
     ...
     <div class="modal fade" id="edit_liveStock<?php echo $pdt->id;?>" tabindex="-1" role="dialog" aria-hidden="true">
                  <div class="modal-dialog">
                     <div class="modal-content">
                        <div class="modal-header modal-header-primary">
                           ...
                           <h3><i class="fa fa-edit m-r-5"></i><?php echo display('edit'); ?> Test</h3>

                        </div>
                        <div class="modal-body">
                           <div class="row">
                              <div class="col-md-12">
                                 <form class="form-horizontal" action="<?php echo base_url(); ?>testinfo/update" method="post" enctype="multipart/form-data">
                                    <fieldset>
                                       <!-- Text input-->
                                       ...
                                       <div class="col-md-12 form-group">
                                          <label class="control-label" for="etestFee">Test Fee</label>
                                          <input type="text"   name="etestFee" value="<?php echo $pdt->testFee;?>" id="etestFee" class="form-control" >
                                       </div>
            ...
            <div class="modal fade" id="add_new_categories" tabindex="-1" role="dialog">
                        <div class="modal-dialog" role="document">
                           <div class="modal-content">
                           <form class="form-horizontal" action="<?php echo base_url(); ?>billinfo/doctors/create" method="post" enctype="multipart/form-data">
                               
                              <div class="modal-header">
                                 <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                 <h4 class=" text-start">Add New Doctor</h4>
                              </div>
                              <div class="modal-body">
                                 <fieldset>
                                       <!-- Text input-->
                                       ...
                                       <div class="col-md-12 form-group">
                                          ...
                                          <input type="text"   name="mobile_no" value="<?php echo set_value('mobile_no'); ?>" id="mobile_no" class="form-control" >
                                          <span class="text-red small"><?php echo form_error('mobile_no'); ?></span>
                                       </div>
                                       <div class="col-md-12 form-group">
                                          <label class="control-label" for="degree">Degree </label>
                                          <input type="text"   name="degree" value="<?php echo set_value('degree'); ?>" id="degree" class="form-control" >
...
function confirmDelete(userId){
 ...
 confirmButtonText: "Yes, delete it!"
  ...
  if (result.value) {
    window.location.href = "<?php echo base_url();?>billinfo/doctors/delete/"+userId;
  }
}); 
