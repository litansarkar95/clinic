...
<form method="post" action="<?= base_url()."billinfo/list" ?>">
  <div class="filter-row bg-light p-3 rounded-3 shadow-sm mb-3">
								...
								<div class="row px-3">
									<div class="col-12">
                                     ...
                                     <td><?php echo $pdt->totalAmount;?></td>
                                      <td><?php echo $pdt->isPaid ;
                                       ?></td>
                                       <td><?php echo date('d-m-Y',$pdt->created_at); ?></td>
													                <td>
                                                       <button  type="button"     class="btn btn_bg"   data-bs-toggle="modal"    data-bs-target="#exampleModal<?php echo $pdt->id; ?>">
                            ...
                            <div
                              class="modal fade"
                              id="exampleModal<?php echo $pdt->id; ?>"   tabindex="-1"     aria-labelledby="exampleModalLabel"    aria-hidden="true">
                              <div class="modal-dialog">
                                <div class="modal-content">
                                  <div class="modal-header">
                                    <h1    class="modal-title fs-5 text-bold"    id="exampleModalLabel">    Due Amount - <?php echo $pdt->name;?>    </h1>
                                    <button    type="button"  class="btn-close"   data-bs-dismiss="modal"   aria-label="Close"></button>
                                  </div>
                                  <div class="modal-body">
                                    <form action="<?php echo base_url(); ?>billinfo/account" method="post" class="">
                                          <input type="text" class="form-control" name="id" value="<?php echo $pdt->id; ?>"  />
                                      <div class="row mb-3">
                                        <div class="col-12">
                                          <label for="name">Due Amount </label>
                                          <input type="text" class="form-control" value="<?php echo $pdt->dueAmount; ?>" readonly />
                                        </div>
                                      </div>
