...
.costing-list span {
  ...
  <!-- .col-sm-7 -->
                  <div class="col-sm-12">
                   ...
                   <span class="btn-label"><i class="glyphicon glyphicon-plus"></i></span>Add New Test
                      </button>
     ...
     <div class="modal fade" id="edit_liveStock<?php echo $pdt->id;?>" tabindex="-1" role="dialog" aria-hidden="true">
            ...
            <div class="modal fade" id="add_new_categories" tabindex="-1" role="dialog">
                        <div class="modal-dialog" role="document">
                           <div class="modal-content">
                           <form class="form-horizontal" action="<?php echo base_url(); ?>testinfo/create" method="post" enctype="multipart/form-data">
                               
                              <div class="modal-header">
                                 <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                 <h4 class=" text-start">Add New Test</h4>
                              </div>
                              <div class="modal-body">
                                 <fieldset>
                                       <!-- Text input-->
                                       ...
                                       <div class="col-md-12 form-group">
                                          <label class="control-label" for="testFee">Test Fee</label>
                                          <input type="text"   name="testFee" value="<?php echo set_value('testFee'); ?>" id="testFee" class="form-control" >
                                          <span class="text-red small"><?php echo form_error('testFee'); ?></span>
                                       </div>
