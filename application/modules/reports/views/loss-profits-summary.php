...
<div class="page">
  <div class="header">
    ...
    <p>বিবির বাজার রোড, ঝাউতলা, আদর্শ সদর, কুমিল্লা-৩৫০০</p>
    <div class="title">অস্ত্রোপচারের সম্মতিপত্র</div>
  </div>

  <div class="content">
    চিকিৎসার প্রার্থী <span class="dotted"></span> বয়স <span class="dotted"></span> পুরুষ/স্ত্রী <span class="dotted"></span><br>
    জাতীয়তা <span class="dotted"></span> পেশা <span class="dotted"></span> ধর্ম <span class="dotted"></span><br>
    পিতা/মাতা/অভিভাবকের নাম <span class="dotted" style="width: 300px;"></span><br><br>

    চিকিৎসার প্রার্থী আমি নিজে অথবা পুত্র/কন্যা/ভাই/বোন/স্বামী/স্ত্রী <span class="dotted" style="width: 250px;"></span>–কে<br>
    উপরোক্ত চিকিৎসার প্রার্থী হিসেবে অনুমতি দিচ্ছি যে, প্রয়োজনীয় হলে অস্ত্রোপচার <span class="dotted" style="width: 200px;"></span> করা হবে।<br><br>
  ...
  <div class="footer">
    © Rotary Eye Hospital — A4 Print Ready Form
  </div>
</div>
