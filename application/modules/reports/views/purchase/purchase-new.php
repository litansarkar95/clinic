               ...
               <div class="col-md-7 col-md-offset-3">
                  ...
                  <h4>Purchase Reports </h4>
                     ...
                     <div class="panel-body">
                        <form  action="<?php echo base_url(); ?>reports/purchasesearch"target="_blank" method="post" enctype="multipart/form-data">
                           ...
                           <div class="form-group col-md-12">
                                 <label for="customer_id"><?php echo display('supplier'); ?></label>
