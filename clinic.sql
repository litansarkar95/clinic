...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 22, 2025 at 01:11 PM
...
(1221, 0, 0, 0, 0, 0, '', '::1', '2025', 10, 1, 'R-0001', 1237, 0, 100, 'flat', 0, 0, 'Due', 100, 0, 100, 'Cash', 1760724000, 0, 1, 1760768290, 0),
(1222, 0, 0, 0, 0, 0, '', '::1', '2025', 10, 2, 'R-0002', 1237, 0, 100, 'flat', 0, 0, 'Due', 100, 0, 100, 'Cash', 1760724000, 1, 1, 1760772089, 0),
(1223, 0, 0, 0, 0, 0, '', '::1', '2025', 10, 3, 'R-0003', 1237, 0, 100, 'flat', 0, 0, 'Due', 100, 0, 100, 'Cash', 1760724000, 1, 1, 1760772150, 0),
(1225, 0, 0, 0, 0, 0, '', '::1', '2025', 10, 4, 'R-0004', 1237, 0, 1100, 'flat', 0, 0, 'Due', 1100, 0, 1100, 'Cash', 1761069600, 0, 1, 1761130409, 0),
(1226, 0, 0, 0, 0, 0, '', '::1', '2025', 10, 5, 'R-0005', 1237, 0, 450, 'flat', 0, 0, 'Due', 450, 0, 450, 'Cash', 1761069600, 0, 1, 1761130784, 0);
...
INSERT INTO `branch` (`id`, `name`, `mobile_no`, `email`, `address`, `is_active`, `create_date`) VALUES
(1, 'Comilla Main Branch', '0192726', 'ac@gmail.com', 'Comilla Main', 1, 1761116080);
...
(6, 'Man', '', '', 1, 1, 1761125154),
(7, 'Woman', '', '', 1, 1, 1761125161);
...
(18, '3333', 'MBBS LIMA', '01918272', '', 1, '2025-10-18 07:22:00');

-- --------------------------------------------------------

--
-- Table structure for table `facials`
--

CREATE TABLE `facials` (
  `id` int(11) NOT NULL,
  ...
  `final_price` decimal(10,2) GENERATED ALWAYS AS (`regular_price` - `discount_amount`) STORED,
...
--
-- Dumping data for table `facials`
--
...
(1, 0, 1, 'super@admin.com', 'UHZVdVBOTWI0VkwrN0MvQjRRRUZkdz09', 1, 1, '2025-10-22 12:26:45', '2024-10-21 15:42:57', '2025-10-22 12:26:45'),
...
(5, 'New Record inserted On patients id 1231', 1231, 6, 'Insert', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWeb', '2025-10-15 05:24:32', '2025-10-15'),
(6, 'New Record inserted On bill_details id 1270', 1270, 6, 'Insert', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWeb', '2025-10-15 05:24:44', '2025-10-15'),
(7, 'New Record inserted On testinfo id 53', 53, 36, 'Insert', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWeb', '2025-10-15 06:29:48', '2025-10-15'),
(8, 'New Record inserted On categories id 3', 3, 36, 'Insert', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWeb', '2025-10-15 09:14:38', '2025-10-15'),
(9, 'New Record inserted On categories id 4', 4, 36, 'Insert', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWeb', '2025-10-15 09:14:58', '2025-10-15'),
(10, 'New Record inserted On testinfo id 54', 54, 36, 'Insert', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWeb', '2025-10-15 09:15:49', '2025-10-15'),
(11, 'New Record inserted On testinfo id 55', 55, 36, 'Insert', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWeb', '2025-10-15 09:16:23', '2025-10-15'),
(12, 'New Record inserted On testinfo id 56', 56, 36, 'Insert', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWeb', '2025-10-15 09:16:50', '2025-10-15'),
(13, 'New Record inserted On patients id 1232', 1232, 36, 'Insert', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWeb', '2025-10-15 09:22:08', '2025-10-15'),
(14, 'New Record inserted On bill_details id 1272', 1272, 36, 'Insert', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWeb', '2025-10-15 09:22:09', '2025-10-15'),
(15, 'Record deleted On testinfo id ', NULL, 36, 'Update', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWeb', '2025-10-15 09:50:30', '2025-10-15'),
(16, 'New Record inserted On categories id 5', 5, 36, 'Insert', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWeb', '2025-10-15 10:21:44', '2025-10-15'),
(17, 'New Record inserted On testinfo id 57', 57, 36, 'Insert', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWeb', '2025-10-15 10:22:43', '2025-10-15'),
(18, 'New Record inserted On testinfo id 58', 58, 36, 'Insert', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWeb', '2025-10-15 10:22:55', '2025-10-15'),
(19, 'New Record inserted On testinfo id 59', 59, 36, 'Insert', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWeb', '2025-10-15 10:23:08', '2025-10-15'),
(20, 'New Record inserted On patients id 1233', 1233, 6, 'Insert', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWeb', '2025-10-16 04:03:50', '2025-10-16'),
(21, 'New Record inserted On bill_details id 1279', 1279, 6, 'Insert', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWeb', '2025-10-16 04:04:17', '2025-10-16'),
(22, 'Record deleted On setting id ', NULL, 6, 'Update', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWeb', '2025-10-16 09:16:18', '2025-10-16'),
(23, 'Record deleted On setting id ', NULL, 6, 'Update', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWeb', '2025-10-16 09:16:24', '2025-10-16'),
(24, 'Record deleted On setting id ', NULL, 6, 'Update', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWeb', '2025-10-16 09:16:38', '2025-10-16'),
(25, 'Record deleted On setting id ', NULL, 6, 'Update', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWeb', '2025-10-16 09:16:48', '2025-10-16'),
...
(40, 'New Record inserted On testinfo id 60', 60, 6, 'Insert', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWeb', '2025-10-18 06:15:00', '2025-10-18'),
(41, 'New Record inserted On patients id 1237', 1237, 6, 'Insert', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWeb', '2025-10-18 06:15:25', '2025-10-18'),
(42, 'New Record inserted On bill_details id 1287', 1287, 6, 'Insert', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWeb', '2025-10-18 06:15:25', '2025-10-18'),
(43, 'New Record inserted On doctors id 18', 18, 6, 'Insert', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWeb', '2025-10-18 07:22:01', '2025-10-18'),
(44, 'New Record inserted On patients id 1238', 1238, 6, 'Insert', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWeb', '2025-10-19 16:17:28', '2025-10-19'),
(45, 'New Record inserted On bill_details id 1291', 1291, 6, 'Insert', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWeb', '2025-10-19 16:17:28', '2025-10-19'),
(46, 'New Record inserted On patients id 1239', 1239, 6, 'Insert', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWeb', '2025-10-19 16:18:09', '2025-10-19'),
(47, 'Record deleted On patients id ', NULL, 6, 'Delete', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWeb', '2025-10-19 16:43:45', '2025-10-19'),
(48, 'New Record inserted On patients id 1240', 1240, 6, 'Insert', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWeb', '2025-10-19 16:47:40', '2025-10-19'),
(49, 'New Record inserted On bill_details id 1293', 1293, 6, 'Insert', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWeb', '2025-10-19 16:47:40', '2025-10-19'),
(50, 'Record deleted On patients id ', NULL, 6, 'Delete', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWeb', '2025-10-19 16:49:59', '2025-10-19'),
(51, 'Record deleted On transactions id ', NULL, 6, 'Delete', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWeb', '2025-10-19 16:49:59', '2025-10-19'),
(52, 'Record deleted On bill_details id ', NULL, 6, 'Delete', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWeb', '2025-10-19 16:49:59', '2025-10-19'),
(53, 'Record deleted On bill_info id ', NULL, 6, 'Delete', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWeb', '2025-10-19 17:01:27', '2025-10-19'),
(54, 'Record deleted On transactions id ', NULL, 6, 'Delete', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWeb', '2025-10-19 17:01:27', '2025-10-19'),
(55, 'Record deleted On bill_details id ', NULL, 6, 'Delete', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWeb', '2025-10-19 17:01:27', '2025-10-19'),
(56, 'New Record inserted On branch  id 1', 1, 1, 'Insert', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWeb', '2025-10-22 06:54:40', '2025-10-22'),
(57, 'New Record inserted On branch  id 2', 2, 1, 'Insert', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWeb', '2025-10-22 06:55:29', '2025-10-22'),
(58, 'Record deleted On branch id ', NULL, 1, 'Update', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWeb', '2025-10-22 07:02:16', '2025-10-22'),
(59, 'Record deleted On branch id ', NULL, 1, 'Delete', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWeb', '2025-10-22 07:04:19', '2025-10-22'),
(60, 'New Record inserted On staff  id 16', 16, 1, 'Insert', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWeb', '2025-10-22 09:14:58', '2025-10-22'),
(61, 'New Record inserted On login_credential id 19', 19, 1, 'Insert', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWeb', '2025-10-22 09:14:58', '2025-10-22'),
(62, 'Record deleted On categories id ', NULL, 1, 'Delete', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWeb', '2025-10-22 09:25:45', '2025-10-22'),
(63, 'Record deleted On categories id ', NULL, 1, 'Delete', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWeb', '2025-10-22 09:25:48', '2025-10-22'),
(64, 'Record deleted On categories id ', NULL, 1, 'Delete', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWeb', '2025-10-22 09:25:50', '2025-10-22'),
(65, 'New Record inserted On categories id 6', 6, 1, 'Insert', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWeb', '2025-10-22 09:25:55', '2025-10-22'),
(66, 'New Record inserted On categories id 7', 7, 1, 'Insert', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWeb', '2025-10-22 09:26:01', '2025-10-22'),
(67, 'New Record inserted On facials id 1', 1, 1, 'Insert', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWeb', '2025-10-22 09:59:18', '2025-10-22'),
(68, 'New Record inserted On facials id 2', 2, 1, 'Insert', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWeb', '2025-10-22 10:07:42', '2025-10-22'),
(69, 'New Record inserted On facials id 3', 3, 1, 'Insert', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWeb', '2025-10-22 10:08:57', '2025-10-22'),
(70, 'Record deleted On facials id ', NULL, 1, 'Delete', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWeb', '2025-10-22 10:16:10', '2025-10-22'),
(71, 'Record deleted On testinfo id ', NULL, 1, 'Update', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWeb', '2025-10-22 10:36:53', '2025-10-22'),
(72, 'Record deleted On testinfo id ', NULL, 1, 'Update', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWeb', '2025-10-22 10:37:25', '2025-10-22'),
(73, 'Record deleted On testinfo id ', NULL, 1, 'Update', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWeb', '2025-10-22 10:37:42', '2025-10-22'),
(74, 'Record deleted On testinfo id ', NULL, 1, 'Update', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWeb', '2025-10-22 10:37:56', '2025-10-22'),
(75, 'Record deleted On testinfo id ', NULL, 1, 'Update', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWeb', '2025-10-22 10:38:03', '2025-10-22'),
(76, 'Record deleted On testinfo id ', NULL, 1, 'Update', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWeb', '2025-10-22 10:38:43', '2025-10-22'),
(77, 'New Record inserted On facials id 4', 4, 1, 'Insert', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWeb', '2025-10-22 10:42:21', '2025-10-22'),
(78, 'New Record inserted On facials id 5', 5, 1, 'Insert', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWeb', '2025-10-22 10:42:30', '2025-10-22'),
(79, 'New Record inserted On facials id 6', 6, 1, 'Insert', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWeb', '2025-10-22 10:42:38', '2025-10-22'),
(80, 'New Record inserted On facials id 7', 7, 1, 'Insert', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWeb', '2025-10-22 10:42:49', '2025-10-22'),
(81, 'Record deleted On facials id ', NULL, 1, 'Update', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWeb', '2025-10-22 11:07:38', '2025-10-22'),
(82, 'Record deleted On facials id ', NULL, 1, 'Update', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWeb', '2025-10-22 11:10:53', '2025-10-22');
...
INSERT INTO `patients` (`id`, `month`, `day`, `year`, `serial_no`, `registration_no`, `name`, `registration_date`, `father_husband_name`, `mobile_no`, `gender`, `age`, `district_id`, `upazilla_id`, `village`, `occupation_id`, `religion`, `nationality_id`, `doctor_id`, `adult_child`, `bed_type`, `bed`, `is_old_patient`, `is_active`, `create_date`, `registration_int_no`) VALUES
(1237, 10, 18, 2025, 1, 'P-0001', 'Litan', 1760724000, 'Ibrahim', '09182262', 'Male', '32', 1, 2, 'eee', 1, 'Islam', 1, 14, 'Adult', '', '', 0, 1, 1760768125, 1),
(1238, 10, 19, 2025, 1, 'P-0002', 'lopa', 1760810400, 'sasdads', '122332', 'Male', '321332', 1, 3, '22332', 3, 'Islam', 1, 14, 'Adult', '', '', 0, 1, 1760890648, 2);
...
(1, 'রোটারি চক্ষু হাসপাতাল', 'Rotary Eye Hospital', '', 'বিরিঞ্চ বাজার রোড, জয়শংকরপুর, আদর্শ সদর, কুমিল্লা, ৩৫০০', 'info@rckushtia.org', '01767-622322', '', '', '', '', '', '9ba100181b3e12ded0999de01a4285d0.jpg', '7f0d0845de4fba487bc9fb5cf8b49775.jpeg', 'BD', 'BD', '$', 'english', 'Asia/Dhaka', '');
